...
- [x] Редактирование плана - все поля + счет с какого, счет на какой.
...
- [x] Восстановить пароль
    - [x] Получить ссылку c автоголином на почту
...
- [x] Cтраниа бюджетов 
    ...
    - [x] Детальная страница бюджета на которой отображается.
        - [ ] Когда бюджет был создан
        - [ ] Кто владелец бюджета, со ссылкой на страницу автора
        - [x] Список тех, кто участвует в бюджете, с уровнем доступа к бюджету
            - [ ] Дав уровня: Просмотр, Управление
        - [x] Возможность добавить человека в бюджет из списка друзей 
...
# Объекты 
(не очень актуальная информация)
